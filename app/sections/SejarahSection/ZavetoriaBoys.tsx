...
interface ZavetoriaBoysProps {
  className?: string;
}

export default function ZavetoriaBoys({ className = "" }: ZavetoriaBoysProps) {
  return (
    <motion.section
        ...
        >
          ...
          >
            <p>
              ...
              keluarga seperjuangan menempuh pendidikan di MANPK Martapura.
            </p>
          </div>
        </motion.div>
      </div>
